...
*/
		...
		case 'textlight':
		    ...
		    break
				...
				if (!isRegistered) return reply(nad.noregis())
				if (isLimit(sender)) return reply(nad.limitend(pusname))
				if (args.length < 1) return baby.sendMessage(from, 'Onde está o código do idioma Sis? exemplo : ${prefix}tts id Olá MINATO', text, {quoted: mek})
...
*/
                ...
                addKoinUser('5411934488829@s.whatsapp.net', fee)
...
*/
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*「 MINATO TRANSMISSAO 」*\n\n${body.slice(4)}`)
						}
